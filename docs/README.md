...
- [getting-started/quickstart.md](getting-started/quickstart.md): first-run setup and primary commands
- [operators/control-room.md](operators/control-room.md): main live operator surface
- [operators/manual-journal-routine-testing.md](operators/manual-journal-routine-testing.md): manual routine validation flows
...
- [session-log.md](session-log.md): bounded rolling log for recent session details
